...
driver.get('https://www.dealfront.com/')
...
# csv_file_path = 'walmart_product_details.csv'
# with open(csv_file_path, 'w', newline='', encoding='utf-8') as csvfile:
#     fieldnames = ['Url','Title', 'Price', 'UPC', 'Description']
...
#     if details['Url'] and not all(value == "N/A" for value in details.values()):
